...
String testVm = "to-qa-strato-centos7"
...
// ESF parameters.
def baseParameter = [
  new StringParameterValue("TARGET_DOMAIN", "to-qa-strato-centos7.epages.systems"),
  ...
  parallel (
    ...
    ecms: {
      def esfParameters = baseParameter + [
                          ...
                          new StringParameterValue("TESTGROUPS", "testShopECMS")]
      esf.runEsfTests(esfParameters)
    },
    us: {
      def esfParameters = baseParameter + [
